  ...
  render() {
    ...
    return (
      <div className="topbar">
        ...
        {/* Logo */}
        <img className="logo" src={logoHeader} onClick={() => window.location.replace('/v1/index.html#/dashboard')} />
        <img className="logo-small" src={logoHeaderSmall} onClick={() => window.location.replace('/v1/index.html#/dashboard')} />
        {/* Loading */}
